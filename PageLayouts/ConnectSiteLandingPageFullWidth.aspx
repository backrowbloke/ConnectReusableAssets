...
<asp:Content ContentPlaceholderID="PlaceHolderAdditionalPageHead" runat="server">
	...
	<link id="CSS1" href="<% $SPUrl:~SiteCollection/_catalogs/masterpage/enhancements/css_babcockintranets.css?v=6%>" runat="server" type="text/css" rel="stylesheet" />
	<link id="CSS2" href="<% $SPUrl:~SiteCollection/_catalogs/masterpage/enhancements/css_babcockintranets_noql.css?v=6%>" runat="server" type="text/css" rel="stylesheet" />
	<style type="text/css">
...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	<div class="connect-col-r">
		<WebPartPages:WebPartZone id="FarRight" runat="server" title="Column Right"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
	</div>
	...
	<div class="article article-body connect-article-body">
		...
		<div>
			<div class="connect-col-wp-third">
				<WebPartPages:WebPartZone id="BottomLeft" runat="server" title="Bottom Left "><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
			</div>
			<div class="connect-col-wp-third">
				<WebPartPages:WebPartZone id="BottomRight" runat="server" title="Bottom Right "><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
			</div>
		</div>
