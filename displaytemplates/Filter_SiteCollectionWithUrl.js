...
function DisplayTemplate_BabcockFilterSiteCollectionWithUrl(ctx) {
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_BabcockFilterSiteCollectionWithUrl.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_SiteCollectionWithUrl.js';
...
,''
			...
			jQuery.ajax({
		        ...
		        headers:{
		            'Accept': 'application/json; odata=verbose'
		                                ...
		                                success:function(data){siteTitle = data.d.Title;},
		                                error:function(data, message,s){}
		  });
		  url = url.replace('https://connect.babcockinternational.com','');
		  siteTitle = siteTitle + ' (' + url + ')';
    ...
    else if (hasControl && !$isNull(listData))
    {
        ...
        for(var i in listData)
        {
            ...
            listData[i].RefinementName = SetSiteTitle(listData[i].RefinementValue);
...
,'                    <div id="RefinementName" class="', nameClass ,'" style="white-space: normal;"> ', $htmlEncode(refinementName) ,' </div>'
);
                if (showCounts) {
ms_outHtml.push(''
...
function RegisterTemplate_BabcockFilterSiteCollection() {

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("BabcockSiteRefinementFilterWith Url", DisplayTemplate_BabcockFilterSiteCollectionWithUrl);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_SiteCollectionWithUrl.js", DisplayTemplate_BabcockFilterSiteCollectionWithUrl);
}

}
RegisterTemplate_BabcockFilterSiteCollection();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_SiteCollectionWithUrl.js"), RegisterTemplate_BabcockFilterSiteCollection);
}