function ULSuYL(){var o=new Object;o.ULSTeamName="Search Server";o.ULSFileName="Filter_CommunityTopic.js";return o;}
function DisplayTemplate_FilterCommunityTopic(ctx) {ULSuYL:;
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_FilterCommunityTopic.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_CommunityTopic.js';
...
,'            ', Srch.U.collapsibleRefinerTitle(ctx.RefinementControl.propertyName, ctx.ClientControl.get_id(), refinerCatTitle, iconClass) ,''
            ...
            function outputFilter(refinementName, refinementCount, refiners, method, aClass, showCounts) {ULSuYL:;
                ...
                var cleansedRefinementName = refinementName;
                if (cleansedRefinementName.indexOf(' - ') > -1) {
                	cleansedRefinementName = cleansedRefinementName.substring(cleansedRefinementName.indexOf(' - ')+3);
                }
...
,'                    <div id="RefinementName" class="', nameClass ,'"> ', $htmlEncode(cleansedRefinementName) ,' </div>'
);
                if (showCounts) {
ms_outHtml.push(''
...
function RegisterTemplate_FilterCommunityTopic() {ULSuYL:;

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("4", DisplayTemplate_FilterCommunityTopic);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_CommunityTopic.js", DisplayTemplate_FilterCommunityTopic);
}

}
RegisterTemplate_FilterCommunityTopic();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_CommunityTopic.js"), RegisterTemplate_FilterCommunityTopic);
}
