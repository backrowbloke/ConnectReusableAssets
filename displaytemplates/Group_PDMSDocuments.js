function ULSw5B(){var o=new Object;o.ULSTeamName="Search Server";o.ULSFileName="Group_Tasks.js";return o;}

function removeItem(id) {
	jQuery('#' + id).hide();
	var tasksToHide = [];
		if (sessionStorage.hiddenTasks != undefined) {
			tasksToHide = JSON.parse(sessionStorage.hiddenTasks);
		}
	tasksToHide.push(id);
	sessionStorage.hiddenTasks = JSON.stringify(tasksToHide);
	
}

function DisplayTemplate_GroupTasks(ctx) {ULSw5B:;
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_GroupTasks.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fGroup_Tasks.js';
...
function RegisterTemplate_GroupTasks() {ULSw5B:;

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("Group_Tasks", DisplayTemplate_GroupTasks);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fGroup_Tasks.js", DisplayTemplate_GroupTasks);
}

}
RegisterTemplate_GroupTasks();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fGroup_Tasks.js"), RegisterTemplate_GroupTasks);
}
