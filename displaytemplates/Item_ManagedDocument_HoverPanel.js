function ULSWtC(){var o=new Object;o.ULSTeamName="Search Server";o.ULSFileName="Item_ManagedDocument_HoverPanel.js";return o;}
...
function DisplayTemplate_ManagedDocumentHoverPanel(ctx) {ULSWtC:;
  ...
  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fItem_ManagedDocument_HoverPanel.js';
  ...
  else
  {
      			htmlMarkup += String.format('<div class="ms-srch-hover-viewerContainer"><iframe id="{0}" src="{1}" scrolling="no" frameborder="0px" class="ms-srch-hover-viewer"></iframe></div>', $htmlEncode(id + HP.ids.viewer), previewUrl);
 					...
 					htmlMarkup += String.format('</div>' + 
                                  ...
                                  '<div class="itemdetail"><div class="detailsitem detailslabel">Type: </div><div>{4}</div></div><div class="itemdetail"><div class="detailsitem detailslabel">Reference: </div><div>{3}</div></div><div class="detailscolumn"><div class="detailsitem detailslabel">Author: </div><div>{5}</div></div><div class="detailsitem detailslabel">Modified: </div><div>{6}</div></div><div class="itemdetail"><div class="detailsitem detailslabel">Owner: </div><div>{1}</div></div><div class="itemdetail"><div class="detailsitem detailslabel">Function: </div><div>{7}</div></div><div class="itemdetail"><div class="detailsitem detailslabel">Review Date: </div><div>{2}</div></div></div>', title, docowner, reviewdate, docRef, contentTypeText, author, parseDateFromUTC(modifiedDate),docFunction);//7
...
if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("Item_ManagedDocument_HoverPanel.js", DisplayTemplate_ManagedDocumentHoverPanel);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fItem_ManagedDocument_HoverPanel.js", DisplayTemplate_ManagedDocumentHoverPanel);
}

}
RegisterTemplate_ManagedDocumentHoverPanel();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fItem_ManagedDocument_HoverPanel.js"), RegisterTemplate_ManagedDocumentHoverPanel);
}
