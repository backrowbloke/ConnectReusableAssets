...
function DisplayTemplate_ConnectArticlePage(ctx) {
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_ConnectArticlePage.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fItem_ConnectArticleWebPage.js';
  ctx['DisplayTemplateData']['TemplateType']='Item';
  ctx['DisplayTemplateData']['TargetControlType']=['SearchResults'];
  this.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['ManagedPropertyMapping']={'Title':['Title'], 'Path':['Path'], 'Description':['Description'], 'EditorOWSUSER':['EditorOWSUSER'], 'LastModifiedTime':['LastModifiedTime'], 'CollapsingStatus':['CollapsingStatus'], 'DocId':['DocId'], 'HitHighlightedSummary':['HitHighlightedSummary'], 'HitHighlightedProperties':['HitHighlightedProperties'], 'FileExtension':['FileExtension'], 'ViewsLifeTime':['ViewsLifeTime'], 'ParentLink':['ParentLink'], 'FileType':['FileType'], 'IsContainer':['IsContainer'], 'SecondaryFileExtension':['SecondaryFileExtension'], 'DisplayAuthor':['DisplayAuthor'], 'CommentsOWSMTXT':['CommentsOWSMTXT'], 'PublishingPageContentOWSHTML':['PublishingPageContentOWSHTML'], 'Organisation':['Organisation'], 'Classification':['Classification'], 'DocumentFunction':['DocumentFunction']};
...
,'                    <img id="', $htmlEncode(id + Srch.U.Ids.icon) ,'" onload="this.style.display=\'inline\'" src="/_layouts/15/images/ichtm.gif" />'
,'                </div>'
);
...
,'                </h3>'
,'            </div>'
,'            <div id="', $htmlEncode(id + Srch.U.Ids.summary) ,'" class="ms-srch-item-summary">Type: Connect Article</div><br />'
,'            '
); 
						if (!$isEmptyString(ctx.CurrentItem.DocumentFunction)) { 
ms_outHtml.push(''
,'                <div id="', $htmlEncode(id + Srch.U.Ids.summary) ,'" class="ms-srch-item-summary">Function: ', ctx.CurrentItem.DocumentFunction ,'</div>'
); 
            }
            
            
						if (!$isEmptyString(ctx.CurrentItem.PublishingPageContentOWSHTML)) { 
ms_outHtml.push(''
,'                <div id="', $htmlEncode(id + Srch.U.Ids.summary) ,'" class="ms-srch-item-summary connect-webpage-summary" style="height:150px; overflow:hidden; border:1px solid #c6c6c6">', ctx.CurrentItem.PublishingPageContentOWSHTML ,'</div>'
); 
            }
            if (!$isEmptyString(ctx.CurrentItem.CommentsOWSMTXT)) { 
ms_outHtml.push(''
,'                <div id="', $htmlEncode(id + Srch.U.Ids.summary) ,'" class="ms-srch-item-summary">', ctx.CurrentItem.CommentsOWSMTXT ,'</div>'
); 
            }
...
function RegisterTemplate_ConnectArticlePage() {

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("Item_WebPage", DisplayTemplate_ConnectArticlePage);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fItem_ConnectArticleWebPage.js", DisplayTemplate_ConnectArticlePage);
}

}
RegisterTemplate_ConnectArticlePage();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fItem_ConnectArticleWebPage.js"), RegisterTemplate_ConnectArticlePage);
}