...
function DisplayTemplate_BabcockFilterContentType(ctx) {
  ...
  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_SiteType.js';
...
,''
		...
		function SetDisplayValue(title) {
			...
			if (displayValue == 'STS_Web') { 
				displayValue = 'Web'
			}
			if (displayValue == 'STS_Site') { 
				displayValue = 'Site Collection'
			}
			return displayValue;
		}
...
if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_SiteType.js", DisplayTemplate_BabcockFilterContentType);
}

}
RegisterTemplate_BabcockFilterContentType();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_SiteType.js"), RegisterTemplate_BabcockFilterContentType);
}