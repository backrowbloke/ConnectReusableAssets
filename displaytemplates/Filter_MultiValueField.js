...
function DisplayTemplate_BabcockFilterMultiValue(ctx) {
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_BabcockFilterMultiValue.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_MultiValueField.js';
...
,''
	...
	if (listData.length > maxLength) {
		maxLength = listData.length;
	}
	
	var kwcounter = 0;
        for(var i in listData) {
	
		var originalRefinementName = listData[i].RefinementName.split(delimiter);
		for (var kw = 0; kw < originalRefinementName.length; kw++) {
			
			var refinementToken = (originalRefinementName[kw].indexOf('\\') > -1) ? originalRefinementName[kw] : '"' + originalRefinementName[kw] + '"';
			if (kwRefiners.filter(function(kword){return kword.RefinementName === originalRefinementName[kw];}).length < 1 && kwcounter < maxLength) {
				kwRefiners.push({
					RefinementName: originalRefinementName[kw],
					RefinementValue: originalRefinementName[kw],
					RefinementToken: refinementToken,
					RefinementCount: listData[i].RefinementCount,
					RefinementTokenWrappedValues: [Srch.RefinementUtil.stringValueToEqualsToken(originalRefinementName[kw])],
					Modifier: listData[i].Modifier,
					RefinerName: listData[i].RefinerName
	...
	kwRefiners.sort(SortByCountDescending);
	listData = kwRefiners;	

	//for (var i in kwRefiners) {
	//	listData[i].RefinementTokens = [kwRefiners[i].RefinementToken];
	//	listData[i].RefinementValue = [kwRefiners[i].RefinementValue];
	//	listData[i].RefinementName = [kwRefiners[i].RefinementName];
        //    	listData[i].RefinementTokenWrappedValues = [Srch.RefinementUtil.stringValueToEqualsToken(kwRefiners[i].RefinementValue)];
	//}
	for (var i in listData) {
...
function RegisterTemplate_BabcockFilterMultiValue() {

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("BabcockSiteRefinementFilter", DisplayTemplate_BabcockFilterMultiValue);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_MultiValueField.js", DisplayTemplate_BabcockFilterMultiValue);
}

}
RegisterTemplate_BabcockFilterMultiValue();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_MultiValueField.js"), RegisterTemplate_BabcockFilterMultiValue);
}
