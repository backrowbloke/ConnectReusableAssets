...
function DisplayTemplate_BabcockFilterContentType(ctx) {
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_BabcockFilterContentType.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_ContentType.js';
...
,''
		...
		function SetDisplayValue(title) {
			var displayValue = title;
			try {
				displayValue = title.replace('; charset=utf-8','');
				displayValue = displayValue.substring(displayValue.indexOf('/')+1);
				displayValue = displayValue.substring(displayValue.indexOf('\n\n')+1);
			}
			catch(err) {}
			return displayValue;
		}
    ...
    else if (hasControl && !$isNull(listData))
    {
        ...
        for(var i in listData)
        {
            ...
            listData[i].RefinementName = SetDisplayValue(listData[i].RefinementName);
...
function RegisterTemplate_BabcockFilterContentType() {

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("BabcockSiteRefinementFilter", DisplayTemplate_BabcockFilterContentType);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_ContentType.js", DisplayTemplate_BabcockFilterContentType);
}

}
RegisterTemplate_BabcockFilterContentType();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fContentManagement\u002fFilter_ContentType.js"), RegisterTemplate_BabcockFilterContentType);
}